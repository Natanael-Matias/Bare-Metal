...
void	ADC_IRQHandler                 (void) __attribute__ ((weak, alias("Default_Handler")));               			/* ADC2 global interrupts                                             */
...
void	UART7_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));             			/* UART 7 global interrupt                                            */
void	UART8_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));             			/* UART 8 global interrupt                                            */
...
void	SPI6_IRQHandler                (void) __attribute__ ((weak, alias("Default_Handler")));              			/* SPI 6 global interrupt                                             */
void	SAI1_IRQHandler                (void) __attribute__ ((weak, alias("Default_Handler")));              			/* SAI1 global interrupt                                              */
void	LCD_TFT_IRQHandler             (void) __attribute__ ((weak, alias("Default_Handler")));           			/* LTDC global interrupt                                              */
void	LCD_TFT_1_IRQHandler           (void) __attribute__ ((weak, alias("Default_Handler")));         			/* LTDC global error interrupt                                        */
